...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create lopenling-blue-stack-c36d
  fly apps create lopenling-blue-stack-c36d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app lopenling-blue-stack-c36d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app lopenling-blue-stack-c36d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'lopenling-blue-stack-c36d-staging' does not match app name in config file 'lopenling-blue-stack-c36d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name lopenling-blue-stack-c36d-db
  fly postgres attach --app lopenling-blue-stack-c36d lopenling-blue-stack-c36d-db

  fly postgres create --name lopenling-blue-stack-c36d-staging-db
  fly postgres attach --app lopenling-blue-stack-c36d-staging lopenling-blue-stack-c36d-staging-db
  ```
